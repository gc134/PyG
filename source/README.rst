...
represent germination curves, to adjust them (fitting step) in order to
...
select the most interesting parameters and better characterize the overall
variations of germination aspects.
...
example) and more sophisticated tools (as germination metrics with R
...
guiding the user through logical steps in a robust manner. Moreover,
...
* import of csv file
* definition of working folders
* QC data
* group sorting for visualisations
* calculation of germination percents
* visualisation of germination curves
* experimental germination curves fitting
* calculation of germination parameters
...
How to launch it
----------------
Just to double-click on the .exe file to start the interface. The interface
may take a moment to open, the time for the required modules to load.
...
parameters whose list is for the moment limited to 5 essential ones.
